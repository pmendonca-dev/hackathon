# Decision Log — complete Flight Log export

Every decision recorded during the project, in the order it was made.
The subset a judge is most likely to ask us to defend is in
