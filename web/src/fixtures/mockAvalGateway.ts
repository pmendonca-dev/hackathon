...
const MOCK_SNAPSHOT: AvalSnapshot = {
  ...
  human: {
    ...
    latestDecision: {
      ...
      evidenceRef: 'evidence://authorization/proof_103',
    },
    receipts: [
      {
        id: 'rcpt_pay_103',
  ...
  merchant: {
    ...
    signedEvidence: {
      ...
      authorizationProofRef: 'proof_103',
    },
  },
  auditor: {
    ...
    events: [
      {
        ...
        evidenceRef: 'evidence://checkout/chk_103',
      ...
      },
      {
        ...
        reservationState: 'settled',
        evidenceRef: 'evidence://settlement/psp_mock_103',
    ...
    dispute: {
      ...
      evidenceRefs: [
        'evidence://authorization/proof_103',
        'evidence://settlement/psp_mock_103',
        'evidence://revocation/rev_104',
      ],
    },
  },
};
