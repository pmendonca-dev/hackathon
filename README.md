...
.venv/Scripts/python.exe -m pytest -q             # 554 testes
...
variáveis e as duas são necessárias: uma diz que o time quer o modelo, a outra diz que
existe um alcançável. Só uma delas, e as regras assumem.
